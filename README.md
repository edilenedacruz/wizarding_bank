This is my completed solution to Turing's Wizarding Bank challenge. The original markdown can be found at https://github.com/turingschool/challenges/blob/master/wizarding_bank.markdown
